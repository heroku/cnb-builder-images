...
|-----------------------------------|--------------|-------------------------|-------------------------------------|-------------------|-------------|
| [heroku/builder:22][builder-tags] | Ubuntu 22.04 | AMD64                   | [heroku/heroku:22-cnb][heroku-tags] | 0.21.18           | Deprecated  |
| [heroku/builder:24][builder-tags] | Ubuntu 24.04 | AMD64 + ARM64           | [heroku/heroku:24][heroku-tags]     | 0.21.18           | Available   |
| [heroku/builder:26][builder-tags] | Ubuntu 26.04 | AMD64 + ARM64           | [heroku/heroku:26][heroku-tags]     | 0.21.18           | Recommended |

The builder images above include buildpack support for .NET, Go, Java, Node.js, PHP, Python, Ruby, and Scala. The `heroku/builder:26` image also supports front-end websites.
